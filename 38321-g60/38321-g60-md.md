...
1\> if uplink transmission is neither prioritized as specified in clause 5.4.2.2 nor prioritized by upper layer according to TS 23.287 [19]; and
...
\- Tdelta: This field indicates the value (0, 1, 2… 1199) used to control the amount of timing adjustment that MAC entity indicates (as specified in TS 38.213 [6]). The length of the field is 11 bits.
...
\- Pathloss Reference RS ID: This field indicates the Pathloss Reference RS ID identified by *srs-PathlossReferenceRS-Id* as specified in TS 38.331 [5]. It updates the pathloss reference RS for a SRS-resource set indicated by SRS Resource Set ID field. The length of the field is 6 bits;
...
\- SRC: The SRC field carries the 16 most significant bits of the Source Layer-2 ID set to the identifier provided by upper layers as defined in TS 23.287 [19]. The length of the field is 16 bits;

\- DST: The DST field carries the 8 most significant bits of the Destination Layer-2 ID set to the identifier provided by upper layers as defined in TS 23.287 [19]. The length of the field is 8 bits;
